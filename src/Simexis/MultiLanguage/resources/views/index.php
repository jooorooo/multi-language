    ...
    <script>
        jQuery(document).ready(function($){
            ...
            $('.group-select').on('change', function(){
                var group = $(this).val();
                if (group) {
                    window.location.href = '<?= action('\Simexis\MultiLanguage\Controllers\MultilanguageController@getView') ?>/'+$(this).val();
                } else {
                    window.location.href = '<?= action('\Simexis\MultiLanguage\Controllers\MultilanguageController@getIndex') ?>';
                }
            });
