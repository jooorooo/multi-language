...
namespace Simexis\MultiLanguage\Helpers;

use Simexis\MultiLanguage\Helpers\Renderers\Javascript AS JavascriptRenderer;
use Simexis\MultiLanguage\Helpers\Renderers\Stylesheet AS StylesheetRenderer;
